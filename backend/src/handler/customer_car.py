...
async def create_customer_car(customer_car: schemas.CustomerCarCreate, db: AsyncSession = Depends(get_db)):
    """
...
async def read_customers_cars(skip: int = 0, limit: int = 100, db: AsyncSession = Depends(get_db)):
    """
...
async def update_customer_car(customer_car_id: int, customer_car: schemas.CustomerCarUpdate, db: AsyncSession = Depends(get_db)):
    """
