...
<header class="w-full bg-white text-gray-800 border-b border-gray-200">
	...
	<div class="flex items-center justify-between px-6 py-3">
		...
		<div class="flex items-center gap-4">
			<img src="/img/logo/logo-chinos.jpeg" alt="logo" class="w-10 h-10 rounded-full object-cover" />
		...
		<div class="flex items-center gap-4">
			...
			<button
				on:click={logout}
				class="px-4 py-1.5 rounded bg-red-600 hover:bg-red-700 text-white text-sm font-medium
				       transition-colors"
			>
				Salir
			</button>
